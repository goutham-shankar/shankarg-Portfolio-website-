    ...
    return (<>
        ...
        <div className='ml-5 mr-1 sm:ml-28'  >
            <div className='mt-12 sm:mr-36'>
                ...
                <h2 className='container font-bold text-gray-400 font-Mono'>I &apos; m Shankar a Indian based product designer with over 2 years of experience. I specialise in interface design for mobile and web-based applications with a focus on simplicity & usability. I &apos; m passionate about design and technology</h2>
            ...
            <h2 className='inline-block ml-5 text-3xl font-bold text-white font-Mono'>Languages & Tech</h2>
            ...
            <div className="h-56 grid grid-cols-4 gap-1 mt-10  content-center ...">
                ...
                <div className='border-white '>
                    <a href='https://reactjs.org/'>
                        <img src="https://reactjs.org/logo-og.png" alt="My profile" className="object-cover w-20 h-20 ml-2 sm:mr-20 rounded-xl"></img>
                    </a>
                </div>
                <div className='border-white '>
            ...
            <h2 className='inline-block ml-5 text-3xl font-black text-white font-Mono'>About This Site</h2>
